...
HD_PWD='E:/LZY_FPGA/vivado project/frequency_measure/frequency_measure.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log frequency_calculate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source frequency_calculate.tcl -notrace
