...
HD_PWD='E:/LZY_FPGA/vivado project/frequency_measure/frequency_measure.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log frequency_calculate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source frequency_calculate.tcl
